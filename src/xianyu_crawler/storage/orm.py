...
class AppConfig(Base):
    ...
    deep_search_enabled: Mapped[bool] = mapped_column(Boolean, default=False)
    deep_search_interval_seconds: Mapped[float] = mapped_column(Float, default=300.0)
    deep_search_cursor_page: Mapped[int] = mapped_column(Integer, default=6)
