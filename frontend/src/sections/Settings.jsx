...
export default function Settings({ status }) {
  ...
  return <section className="settings-simple">
    ...
    <Card className="form-card premium-card">
      <div className="card-heading"><span className="card-icon"><i className="ti ti-user-check" /></span><div><div className="form-title">账号登录</div><p>使用手机闲鱼扫码，登录信息仅保存在本机。</p></div></div>
